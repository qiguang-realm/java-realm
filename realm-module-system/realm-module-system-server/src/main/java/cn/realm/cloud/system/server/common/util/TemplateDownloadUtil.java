 ...
 * @author QI Guang
 */
public final class TemplateDownloadUtil {
    private static final Logger logger = LoggerFactory.getLogger(TemplateDownloadUtil.class);
